    ...
    def _read(self, file_path: str):
        ...
        for data, best_span in zip(dataset, span_file):
            ...
            if rouge_score > 0.7:
                ...
                span_start_field = IndexField(int(start_idx), None)
                span_end_field = IndexField(int(end_idx), None)
                ...
                # TODO:
                correct_passage_field = LabelField(int(passage_idx), skip_indexing=True)
